                        ...
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 mt-3">
                                    <label for="experiences" class="form-label">Work Experiences <span
                                            class="text-danger">*</span></label>
                                        <textarea name="experiences" id="experiences" cols="30" rows="5" class="form-control">{{ old('experiences') }}</textarea>
                                    @error('experiences')
                                        <span class="text-danger mb-0 pb-0">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-6 mt-3">
                                <label for="projects" class="form-label">Projects <span class="text-danger">*</span></label>
                                    <textarea name="projects" id="projects" cols="30" rows="5" class="form-control">{{ old('projects') }}</textarea>
                                @error('projects')
                                    <span class="text-danger mb-0 pb-0">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-6 mt-3">
                                <label for="skill"s class="form-label">Skills <span class="text-danger">*</span></label>
                                    <textarea name="skills" id="skills" cols="30" rows="5" class="form-control">{{ old('skills') }}</textarea>
                                @error('skills')
                                    <span class="text-danger mb-0 pb-0">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                <div class="col-6 mt-3">
                                    <label for="educations" class="form-label">Educations <span
                                            class="text-danger">*</span></label>
                                        <textarea name="educations" id="educations" cols="30" rows="5" class="form-control">{{ old('educations') }}</textarea>
                                    @error('educations')
                                        <span class="text-danger mb-0 pb-0">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-6 mt-3">
                                    <label for="interests" class="form-label">interests <span
                                            class="text-danger">*</span></label>
                                        <textarea name="interests" id="interests" cols="30" rows="5" class="form-control">{{ old('interests') }}</textarea>
                                    @error('interests')
                                        <span class="text-danger mb-0 pb-0">{{ $message }}</span>
                                    @enderror
                                </div>
