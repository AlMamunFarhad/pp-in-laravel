                            ...
                            <div class="nav-icon">
                                <ul class="list-unstyled d-flex justify-content-center mb-0">
                                    ...
                                    <li><a href="https://www.facebook.com/profile.php?id=100009626361921" target="_blank"
                                            class="icon-hover"><i class="bi bi-facebook"></i></a>
                                    </li>
                                ...
                                <div class="contact-form">
                                    ...
                                    <div class="form">
                                        <form action="{{ route('send.email') }}" method="POST">
                                            ...
                                            <div class="did-floating-label-content">
                                                <textarea class="did-floating-input text-area" name="messages" id="messages" cols="30" rows="4"
                                            ...
                                            <div class="form-btn">
                                                <button type="submit"
                                                    class="rounded-pill custom-btn form-control text-center">SEND</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
